...
- [Metadata Remover](https://ianonymous3000.github.io/metadata-remover/) - Strips metadata from JPEG, PNG, WebP, and AVIF images with browser-side WebAssembly.
...
- [Redline](https://github.com/Tyr-Corgi/Redline) - Open-source client-side PDF editor for annotation, redaction, merging, signatures, page management, and export.

## Audio and Video

- [Audioclipper](https://www.audioclipper.eu/) - Cuts audio, adjusts volume, extracts audio from video, and exports MP3 or WAV with ffmpeg.wasm.
...
- [HermesMarkdown](https://hermesmarkdown.com/) - Markdown editor that works with local folders and saves plain files directly to disk.
...
- [doff](https://github.com/franklioxygen/doff) - Local-first diff workspace for text, images, PDFs, spreadsheets, and folders.
...
- [hat.sh](https://hat.sh/) - Encrypts and decrypts files locally with modern cryptography and no data collection.
...
- [OpenQR](https://github.com/open-qr/openqr) - Open-source QR generator whose basic generation runs in the browser without sign-up or watermarking.

## Tool Suites

- [Candid Tools](https://candidtools.com/) - Collection of client-side image, PDF, formatting, and lookup utilities that keep file processing in the browser.
